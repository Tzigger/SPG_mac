...
void main()
{
    ...
    if (mode == 1) {
        // Iluminare per-vertex: Phong calculat in vertex shader pentru fiecare vertex
        // Fragmentele vor interpola culorile calculate la cele 3 varfuri ale triunghiului
